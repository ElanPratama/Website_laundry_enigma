...
const FooterComponent = () => {
  return (
    <footer className="bg-gray-900 dark:bg-gray-800 mt-9">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a className="flex items-center">
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Laundry</span>
            </a>
          </div>
        ...
        <hr className="my-6 border-gray-700 sm:mx-auto dark:border-gray-600 lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" className="text-gray-400 hover:text-gray-300 dark:hover:text-white">
              <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
              </svg>
              <span className="sr-only">Facebook page</span>
            </a>
            <a href="#" className="text-gray-400 hover:text-gray-300 dark:hover:text-white ms-5">
            ...
            <a href="#" className="text-gray-400 hover:text-gray-300 dark:hover:text-white ms-5">
              <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
                <path fillRule="evenodd" d="M2.484 0h15.032C18.246 0 20 1.73 20 3.867v9.267C20 15.27 18.246 17 16.516 17H2.484C1.304 17 0 15.716 0 14.373V3.627C0 2.284 1.304 1 2.484 1ZM1.307 4.77v10.41h.926V4.77h-.926Zm2.885-.437v10.5h.926v-10.5h-.926Zm2.885 0v10.5h.926v-10.5h-.926Zm2.885 0v10.5h.926v-10.5h-.926Z" clipRule="evenodd" />
              </svg>
